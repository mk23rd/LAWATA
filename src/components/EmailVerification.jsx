...
const EmailVerification = ({ user, onVerificationComplete, onCancel }) => {
  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 top-16 md:inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-md w-full mx-auto max-h-full overflow-y-auto">
        {/* Header */}
