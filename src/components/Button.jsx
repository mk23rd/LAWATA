...
function Button({ text, callfunc, disabled = false, loading = false }) {  
  return (
    ...
    <button onClick={callfunc} disabled={disabled || loading} className='bg-color-b z-30 flex items-center justify-center rounded-xl text-2xl text-color-d w-40 h-10 relative top-2'>
