          ...
          <div className="p-6">
            ...
            {Object.keys(fundings).length === 0 ? (
              <div className="text-center py-16">
                ...
                <a href="/manage" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-color-b to-blue-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl">
                  Browse Projects
