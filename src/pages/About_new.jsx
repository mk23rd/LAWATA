...
const About = () => {
  ...
  return (
    <div className="bg-white text-color-e">
      <section className="relative overflow-hidden bg-white to-white">
        ...
        <div className="grid gap-12 md:grid-cols-[1.2fr,0.8fr] md:items-center">
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-color-b/10 bg-white p-5">
          ...
          <div className="rounded-3xl border border-dashed border-color-b/30 bg-white p-8">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:px-10">
        <div className="grid gap-10 md:grid-cols-[0.8fr,1.2fr] md:items-center">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-inner">
